...
const DICT = {
  ...
  es: {
    ...
    ballot_districts_note:
      "Los escaños de la Cámara de EE. UU., la legislatura estatal, (en el condado de Montgomery) el Concejo del Condado y la Junta Escolar, y (en Maryland) los circuitos de la Corte Suprema se ajustan automáticamente a tu distrito. Los escaños de distrito local de otros condados aún no. Cuál es el tuyo depende de tu dirección exacta, así que se muestra cada distrito hasta que esa búsqueda esté disponible.",
    ballot_state_only_note:
