...
const DICT = {
  en: {
    ...
    record_btn: 'Record',
    stop_recording_btn: 'Stop',
    recording_label: 'Recording… {elapsed}',
    re_record_btn: 'Record again',
    play_btn: 'Play',
    pause_btn: 'Pause',
    transcript_soon: 'Transcript coming soon.',
    record_video_btn: 'Record video',
    key_settings_h: 'Backup & recovery',
    key_h: 'Your signing key',
    key_p: "Arguments, proposals, and other public posts you make are cryptographically signed by a key held only on this device — proof it was really you, even you can't later deny it. Losing this device loses that proof unless you back it up.",
    ...
    key_passphrase_count: '{n}/{min} characters',
    key_export_go: 'Save encrypted backup',
    key_export_share_title: 'Save your VoteRight backup',
    key_export_ok: 'Backup ready.',
    key_import_btn: 'Restore from a backup',
    key_import_file_label: 'Choose backup file',
    ...
    choose_video_btn: 'Choose from library',
    change_media_btn: 'Change',
    media_ready: 'Ready to post ({duration}s)',
  ...
  es: {
    ...
    report_open_btn: 'Reportar',
    report_ph: '¿Qué tiene de malo este hilo?',
    report_btn: 'Enviar reporte',
    ...
    record_btn: 'Grabar',
    stop_recording_btn: 'Detener',
    recording_label: 'Grabando… {elapsed}',
    re_record_btn: 'Grabar de nuevo',
    play_btn: 'Reproducir',
    pause_btn: 'Pausar',
    transcript_soon: 'Transcripción próximamente.',
    key_settings_h: 'Respaldo y recuperación',
    key_h: 'Tu clave de firma',
    key_p: 'Los argumentos, propuestas y otras publicaciones públicas que haces se firman criptográficamente con una clave que solo existe en este dispositivo — prueba de que fuiste realmente tú, que ni tú mismo puedes negar después. Perder este dispositivo pierde esa prueba a menos que la respaldes.',
    ...
    key_passphrase_count: '{n}/{min} caracteres',
    key_export_go: 'Guardar respaldo cifrado',
    key_export_share_title: 'Guarda tu respaldo de VoteRight',
    key_export_ok: 'Respaldo listo.',
    key_import_btn: 'Restaurar desde un respaldo',
    key_import_file_label: 'Elegir archivo de respaldo',
    ...
    record_video_btn: 'Grabar video',
    choose_video_btn: 'Elegir de la biblioteca',
    change_media_btn: 'Cambiar',
    media_ready: 'Listo para publicar ({duration}s)',
